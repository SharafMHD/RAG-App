...
class Asset(SQLAlchemyBase):
    ...
    asset_knowledge_base_id = Column(UUID(as_uuid=True), ForeignKey("knowledge_bases.knowledge_base_id"), nullable=False)  # Foreign key to knowledge_bases.knowledge_base_id
    ...
    # define indexes
    __table_args__ = (
        # Index on asset_knowledge_base_id for faster lookups      
        Index("asset_knowledge_base_id_index", "asset_knowledge_base_id"),
